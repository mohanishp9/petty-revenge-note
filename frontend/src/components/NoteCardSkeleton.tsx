    ...
    >
      ...
      <div className="mb-4 flex items-center gap-3 pl-4">
        ...
        <div className="min-w-0 flex-1 space-y-2">
          ...
          <div className="h-3 w-24 rounded bg-stone-800/10" />
          {/* Date Placeholder */}
          <div className="h-2 w-16 rounded bg-stone-800/10" />
        </div>
      </div>

      {/* Subject Placeholder */}
      <div className="mb-4 pl-4 space-y-2">
        <div className="h-5 w-3/4 rounded bg-stone-800/10" />
      </div>

      {/* Content Placeholder */}
      <div className="mb-6 pl-4 pr-2 space-y-2">
        <div className="h-3 w-full rounded bg-stone-800/10" />
        <div className="h-3 w-full rounded bg-stone-800/10" />
        <div className="h-3 w-4/5 rounded bg-stone-800/10" />
      </div>
      ...
      >
        <div className="h-2 w-32 rounded bg-stone-800/10" />
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 pl-3">
        {[1, 2, 3].map((i) => (
          ...
          >
            <div className="h-4 w-4 rounded-full bg-stone-800/10" />
            <div className="h-2 w-4 rounded bg-stone-800/10" />
          </div>
        ))}
      </div>
      ...
      <div className="mt-4 pl-4">
        <div className="h-2 w-20 rounded bg-stone-800/10" />
      </div>
    </article>
  );
};
